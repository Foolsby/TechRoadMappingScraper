...
import requests
from Data.AmazonProductURLs2 import URLS as AmazonURLs
import pandas as pd

i = 1
my_json_data = []
for url in AmazonURLs:
...
final_df = pd.DataFrame(my_json_data,
                        columns=["Product_Name", "Ratings", "Questions_Answered", "Current_Price", "Savings",
                                 "Category"])
final_df.to_csv("AmazonProducts2.csv")
